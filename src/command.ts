export class Command {
  ...
  public static ESC_r = (n: number) => [Command.ESC, 0x72, n];
  ...
  // https://www.epson-biz.com/modules/ref_escpos/index.php?content_id=107#gs_lparen_cl_fn69
  public static GS_par_L = (kc1: number, kc2: number, x: 1 | 2, y: 1 | 2) => [
